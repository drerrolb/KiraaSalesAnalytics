...
// MARK: - Example Mock Downloader
enum MongoDownloader {
    static func downloadDocuments() throws -> String {
        // Must match the shape of `[Instance]`
        let mock = """
        [
          {
            "_id": 1,
            "INSTANCE_COMPLETION_ENDPOINT": "https://example.com/completion",
            "INSTANCE_AUDIO_ENDPOINT": "https://example.com/audio",
            "INSTANCE_STORAGE_BUCKET": "my-bucket",
            "processMonth": 3,
            "INSTANCE_STATYS": "Running",
            "processYear": 2025,
            "INSTANCE_IMAGE_ENDPOINT": "https://example.com/image",
            "bucketStep04target": "step04-bucket",
            "INSTANCE_API_ENDPOINT": "https://example.com/api",
            "INSTANCE_PDF_ENDPOINT": "https://example.com/pdf",
            "INSTANCE_VIDEO_ENDPOINT": "https://example.com/video",
            "INSTANCE_PINECONE_INDEX": "my-pinecone-index",
            "details": "Some details here",
            "apiEndpoint": "https://example.com/apiEndpoint",
            "bucketStorage": "my-bucket-storage",
            "INSTANCE_DESCRIPTION": "A sample instance for testing",
            "mongoDatabase": "sampleDB",
            "INSTANCE_MEET_ENDPOINT": "https://example.com/meet",
            "INSTANCE_STORAGE_REGION": "us-east-1",
            "INSTANCE_FISCAL_OFFSET": 2,
            "name": "Test Instance",
            "INSTANCE_MAP_ENDPOINT": "https://example.com/map",
            "INSTANCE_NAME": "TestInstance",
            "pageNames": ["Page1", "Page2"],
            "financialOffset": 0,
            "mongoUri": "mongodb://example.com:27017",
            "INSTANCE_DOCUMENT_ENDPOINT": "https://example.com/doc",
            "INSTANCE_PROCESS_YEAR": 2025,
            "INSTANCE_SPREADSHEET_ENDPOINT": "https://example.com/sheet",
            "INSTANCE_MONGO_DATABASE": "myMongoDB",
            "regionStep04target": "us-east-1",
            "INSTANCE_CHAT_ENDPOINT": "https://example.com/chat",
            "INSTANCE_STATUS": "Active",
            "INSTANCE_PRESENTATION_ENDPOINT": "https://example.com/presentation",
            "INSTANCE_PROCESS_MONTH": 3
          }
        ]
        """
        return mock
